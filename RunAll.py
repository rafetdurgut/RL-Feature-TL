...
# parameters = {"pNo":[2500],"Method": ["extreme","average"], "W": [25,50,100], "eps": [0.3, 0.4], "alpha": [0.1, 0.5, 0.9],"gama": [0.5, 0.9],"learning_mode":[0,1],"loadFileName":["None"],'reward_func':[0,1]}
parameters = {"pNo":np.arange(500,5001,250),"Method": ["extreme"], "W": [25], "eps": [0.3], "alpha": [0.9],"gama": [0.5],"learning_mode":[0,1],"loadFileName":["None"],"reward_func":[0]}
