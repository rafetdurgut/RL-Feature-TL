...
parameters = {"pNo":np.arange(500,5001,250),"Method": ["extreme"], "W": [25], "eps": [0.3], "alpha": [0.9],"gama": [0.5],"learning_mode":[0,1],"loadFileName":['CLRL-4-extreme-0.3-25-0.9-0.5-1-False-0-2500.csv'],"reward_func":[0]}
