...
parameters = {"pNo":np.arange(500,5001,250),"Method": ["average"], "W": [25], "eps": [0.4], "alpha": [0.5],"gama": [0.3],"learning_mode":[0,1],"loadFileName":["CLRL-4-average-0.4-25-0.5-0.3-1-False-1000.csv"]}
